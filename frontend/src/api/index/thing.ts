...
enum URL {
    list = '/CSAA/index/thing/list',
    detail = '/CSAA/index/thing/detail',
    addWishUser = '/CSAA/index/thing/addWishUser',
    addCollectUser = '/CSAA/index/thing/addCollectUser',
    getCollectThingList = '/CSAA/index/thing/getCollectThingList',
    getWishThingList = '/CSAA/index/thing/getWishThingList',
    removeCollectUser = '/CSAA/index/thing/removeCollectUser',
    removeWishUser = '/CSAA/index/thing/removeWishUser'
}
