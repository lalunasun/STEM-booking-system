...
enum URL {
    list = '/CSAA/admin/lesson/list',
    create = '/CSAA/admin/lesson/create',
    update = '/CSAA/admin/lesson/update',
    delete = '/CSAA/admin/lesson/delete',
    detail = '/CSAA/admin/lesson/detail',
}
