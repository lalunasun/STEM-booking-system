...
enum URL {
    list = '/CSAA/admin/classification/list',
    create = '/CSAA/admin/classification/create',
    update = '/CSAA/admin/classification/update',
    delete = '/CSAA/admin/classification/delete',
}
