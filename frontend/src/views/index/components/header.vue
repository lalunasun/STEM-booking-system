...
<template>
  <div class="main-bar-view">
    <div class="logo">
      ...
      &nbsp;&nbsp;<a href="/index"
        style="font-size: x-large;font-weight:bolder;color: #0a6aae;">CSAA Guest</a>
    </div>
    <div class="search-entry">
      <img :src="SearchIcon" class="search-icon">
      <input placeholder="Search..." ref="keywordRef" @keyup.enter="search" />
    </div>
    <div class="right-view">
      <template v-if="userStore.user_token">
        <a-dropdown>
          ...
          <div class = "user-info">
            ...
            <span class="username">{{ userData.form.username || 'Get NAME Failed' }}</span>
          </div>
          </a>
          <template #overlay>
            <a-menu>
              ...
              <a-menu-item>
                <a @click="goUserCenter('childView')">My Child</a>
              </a-menu-item>
              <a-menu-item>
                <a @click="goUserCenter('userInfoEditView')">Infonmation</a>
              </a-menu-item>
              <a-menu-item>
                <a @click="quit()">Log out</a>
              </a-menu-item>
            </a-menu>
          </template>
        </a-dropdown>
      ...
      <template v-else>
        <button class="login btn hidden-sm" @click="goLogin()">Log in</button>
      </template>
      ...
      <div>
        <a-drawer title="Notice" placement="right" :closable="true" :maskClosable="true" :visible="msgVisible"
          @close="onClose">
