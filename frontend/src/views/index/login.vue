      ...
      <div class="mail-login" type="login">
        <div class="common-input">
          ...
          <div class="input-view">
            <input placeholder="Account" v-model="pageData.loginForm.username" type="text" class="input">
            <p class="err-view">
            </p>
          </div>
          <!---->
        ...
        <div class="next-btn-view">
          <button class="next-btn btn-active" style="margin: 16px 0px;" @click="handleLogin">Log in</button>
        </div>
      </div>
      <div class="operation">
        <a @click="handleCreateUser" class="forget-pwd" style="text-align: right;">Don't have an account? Sign up</a>
      </div>
    </div>
  </div>
</template>
