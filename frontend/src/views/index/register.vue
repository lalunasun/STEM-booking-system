  ...
  <div class="container">
    ...
    <div class="tel-regist-page pc-style">
      <div class="regist-title">
        ...
        <span @click="router.push({name:'login'})" class="toWxLogin">Sign in</span>
      </div>
      ...
      <div class="regist-padding">
        <div class="common-input">
          ...
          <div class="input-view">
            <input placeholder="Account " v-model="tData.loginForm.username" type="text" class="input">
            <p class="err-view">
            </p>
          </div>
        </div>
      ...
      <div class="regist-padding">
        <div class="common-input">
          <img :src="PwdIcon" class="left-icon">
          <div class="input-view">
            <input placeholder="Confirm Password" v-model="tData.loginForm.repassword" type="password" class="input">
            <p class="err-view">
            </p>
          </div>
        </div>
