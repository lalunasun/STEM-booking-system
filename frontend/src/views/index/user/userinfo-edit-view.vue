      ...
      <div class="list-content">
        <div class="edit-view">
          ...
          <div class="item flex-view">
            ...
            <div class="right-box">
              <input type="text" v-model="tData.form.email" placeholder="Enter your Email" maxlength="100"
                class="input-dom web-input">
            </div>
          </div>
          <div class="item flex-view">
            ...
            <div class="right-box">
              <textarea v-model="tData.form.description" placeholder="Enter biography" maxlength="200" class="intro">
          </textarea>
