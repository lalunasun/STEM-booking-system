    ...
    <div class="order-box">
      ...
      <div class="list">
        ...
        <div class="mine-item flex-view" @click="clickMenu('commentView')">
          ...
          <span>My Comment(St2/3)</span>
        </div>
      </div>
    </div>
    <div class="setting-box">
      <div class="title">Personal Options</div>
      <div class="list">
        <div class="mine-item flex-view" @click="clickMenu('userInfoEditView')">
          <img :src="SettingIconImage" alt="编辑资料">
          <span>Edit Profile</span>
        </div>
        <div class="mine-item flex-view" @click="clickMenu('childView')">
          <img :src="AvatarImg" alt="child">
          <span>My Child</span>
        </div>
...
import ChooseClassIcon from '/@/assets/images/add.svg'
