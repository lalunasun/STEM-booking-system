<template>
              ...
              <a-row :gutter="24">
                <a-col span="24">
                  <a-form-item label="Time period" name="time">
                    <a-input placeholder="Please enter" v-model:value="modal.form.time"></a-input>
                  </a-form-item>
                </a-col>
              </a-row>
            </a-form>
  ...
  <script setup lang="ts">
    ...
    import { createApi, listApi, updateApi, deleteApi } from '/@/api/admin/time';
    ...
    const modal = reactive({
      ...
      rules: {
        time: [{ required: true, message: 'Please enter', trigger: 'change' }],
