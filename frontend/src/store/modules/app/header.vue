...
<template>
  <div class="main-bar-view">
    <div class="logo">
      ...
      &nbsp;&nbsp;<a href="/"
        style="font-size: xx-large;font-family: 楷体;font-weight:bolder;color: orange;">Django酒店管理系统</a>
    </div>
    <div class="search-entry">
      <img :src="SearchIcon" class="search-icon">
      <input placeholder="输入搜索内容" ref="keywordRef" @keyup.enter="search" />
    </div>
    <div class="right-view">
      ...
      <div>
        <a-drawer title="温馨提示" placement="right" :closable="true" :maskClosable="true" :visible="msgVisible"
          @close="onClose">
